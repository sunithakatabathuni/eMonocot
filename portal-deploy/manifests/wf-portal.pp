...
wf-portal::wf-portal { 'wf-portal':
	recoveryController_baseUrl => "http://$portal_host_external",
	registrationController_baseUrl => "http://$portal_host_external",
	...
	download_creator_email => "contact@worldfloraonline.org",
	download_creator_name => "W.Ulate",
	download_meta_description => "Description String",
	download_homepage_url => "http://$portal_host_external",
	download_identifier => "World Flora",
	download_logo_url => "http://about.worldfloraonline.org/images/wfo_logo.png",
	download_publisher_email => "contact@worldfloraonline.org",
	download_publisher_name => "W.Ulate",
	...
	portal_baseUrl => "http://$portal_host_external",
	harvester_baseUrl => "http://$harvester_host_external:8080/world-flora-harvest",
	harvester_url => "http://$harvester_host_external:8080",
